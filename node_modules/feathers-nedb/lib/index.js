...
var Service = function () {
  ...
  _createClass(Service, [{
    ...
    value: function update(id, data, params) {
      ...
      return (0, _utils.nfcall)(this.Model, 'update', query, (0, _lodash2.default)(data, this.id, '_id'), options).then(function () {
        return _this2._findOrGet(id);
      });
    }
  }, {
    key: 'remove',
    value: function remove(id, params) {
      ...
      return this._findOrGet(id, params).then(function (items) {
        return (0, _utils.nfcall)(_this3.Model, 'remove', query, options).then(function () {
          return items;
        });
      });
    }
